  ...
  var btc_stats={
    ...
    for (i=0;i<rez.length;i++){
        if(rez[i].keyword=="btc"){  
            ...
            else if(rez[i].timeStamp.getHours()>=generateDate(14) && rez[i].timeStamp.getHours() < generateDate(13)) {eth_stats.total_positive_sum[10] += rez[i].data.total; eth_stats.total_count[10]++; eth_stats.total_positive_percentage_sum[10]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(13) && rez[i].timeStamp.getHours() < generateDate(12)) {eth_stats.total_positive_sum[11] += rez[i].data.total; eth_stats.total_count[11]++; eth_stats.total_positive_percentage_sum[11]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(12) && rez[i].timeStamp.getHours() < generateDate(11)) {eth_stats.total_positive_sum[12] += rez[i].data.total; eth_stats.total_count[12]++; eth_stats.total_positive_percentage_sum[12]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(11) && rez[i].timeStamp.getHours() < generateDate(10)) {eth_stats.total_positive_sum[13] += rez[i].data.total; eth_stats.total_count[13]++; eth_stats.total_positive_percentage_sum[13]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(10) && rez[i].timeStamp.getHours() < generateDate(9)) {eth_stats.total_positive_sum[14] += rez[i].data.total; eth_stats.total_count[14]++; eth_stats.total_positive_percentage_sum[14]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(9) && rez[i].timeStamp.getHours() < generateDate(8)) {eth_stats.total_positive_sum[15] += rez[i].data.total; eth_stats.total_count[15]++; eth_stats.total_positive_percentage_sum[15]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(8) && rez[i].timeStamp.getHours() < generateDate(7)) {eth_stats.total_positive_sum[16] += rez[i].data.total; eth_stats.total_count[16]++; eth_stats.total_positive_percentage_sum[16]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(7) && rez[i].timeStamp.getHours() < generateDate(6)) {eth_stats.total_positive_sum[17] += rez[i].data.total; eth_stats.total_count[17]++; eth_stats.total_positive_percentage_sum[17]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(6) && rez[i].timeStamp.getHours() < generateDate(5)) {eth_stats.total_positive_sum[18] += rez[i].data.total; eth_stats.total_count[18]++; eth_stats.total_positive_percentage_sum[18]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(5) && rez[i].timeStamp.getHours() < generateDate(4)) {eth_stats.total_positive_sum[19] += rez[i].data.total; eth_stats.total_count[19]++; eth_stats.total_positive_percentage_sum[19]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(4) && rez[i].timeStamp.getHours() < generateDate(3)) {eth_stats.total_positive_sum[20] += rez[i].data.total; eth_stats.total_count[20]++; eth_stats.total_positive_percentage_sum[20]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(3) && rez[i].timeStamp.getHours() < generateDate(2)) {eth_stats.total_positive_sum[21] += rez[i].data.total; eth_stats.total_count[21]++; eth_stats.total_positive_percentage_sum[21]+=rez[i].data.positive_percentage}
            else if(rez[i].timeStamp.getHours()>=generateDate(2) && rez[i].timeStamp.getHours() < generateDate(1)) {eth_stats.total_positive_sum[22] += rez[i].data.total; eth_stats.total_count[22]++; eth_stats.total_positive_percentage_sum[22]+=rez[i].data.positive_percentage}
